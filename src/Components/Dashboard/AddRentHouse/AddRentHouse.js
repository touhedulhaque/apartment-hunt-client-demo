...
const AddRentHouse = () => {
  ...
  const onSubmit = data => {
    fetch('https://fathomless-fjord-14298.herokuapp.com/addRentedApartment', {
      method: 'POST',
      ...
      .then(success => {
        if (success) {
          alert('Your Rented Apartment added successfully.');
        }
      })
  }
  ...
  //     .then((data) => {
  //       alert("New Rented House Added Successfully");
  //     })
  //     .catch((error) => {
  //       console.error(error);
  //     });
    ...
    <div style={containerStyle} className="container-fluid row">
      ...
      <div className="col-md-10 p-4 pr-5 ml-auto">
        <div className="row mb-5 justify-content-md-center">
          <center>
            <h1 className="mt-5 text-center">Add Rent House</h1>
            <h3>{loggedInUser.name}, please fill the form below for rent</h3>
          </center>
        </div>
